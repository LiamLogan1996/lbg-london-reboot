...
def populate():
    product = [ {'ProductCategory': "Bills", 'ProductName': "Glasgow City Council Rent", 'ProductPrice': 464.83},
        ...
        {'ProductCategory': "Food", 'ProductName': "Greggs", 'ProductPrice': 8.53},
        {'ProductCategory': "Food", 'ProductName': "Starbucks", 'ProductPrice': 7.20},
        {'ProductCategory': "Food", 'ProductName': "Costa", 'ProductPrice': 3.40},
        {'ProductCategory': "Food", 'ProductName': "Greggs", 'ProductPrice': 5.82},
        {'ProductCategory': "Food", 'ProductName': "McDonalds", 'ProductPrice': 12.55},
        {'ProductCategory': "Food", 'ProductName': "Just Eat", 'ProductPrice': 45.12},
        {'ProductCategory': "Food", 'ProductName': "Just Eat", 'ProductPrice': 28.50},
        {'ProductCategory': "Alcohol", 'ProductName': "Brewdog", 'ProductPrice': 15.26},
        {'ProductCategory': "Alcohol", 'ProductName': "Shakespeare's Bar", 'ProductPrice': 13.36},
        {'ProductCategory': "Alcohol", 'ProductName': "Weatherspoon's", 'ProductPrice': 18.35},
